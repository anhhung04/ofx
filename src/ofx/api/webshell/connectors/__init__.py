...
from ofx.settings import settings, DATA_DIR
...
class ConnectorRegistry:
    ...
    def get_connector(self, name: str) -> Optional[WebshellConnector]:
    ...
    def _load_connector_from_file(self, py_file: Path) -> int:
        ...
        try:
            ...
            if base_module and hasattr(base_module, 'WebshellConnector'):
                ...
                logger.warning(f"Could not find WebshellConnector base class")
                return 0
        except Exception as e:
    ...
    def get_best_available_connector(self) -> Optional[WebshellConnector]:
...
def get_connector(name: str) -> Optional[WebshellConnector]:
