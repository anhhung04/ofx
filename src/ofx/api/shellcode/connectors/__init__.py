...
class ConnectorRegistry:
    ...
    def get_connector(self, name: str) -> Optional[ShellcodeConnector]:
    ...
    def _load_connector_from_file(self, py_file: Path) -> int:
        ...
        try:
            ...
            if base_module and hasattr(base_module, 'ShellcodeConnector'):
                ...
                logger.warning(f"Could not find ShellcodeConnector base class")
                return 0
        except Exception as e:
    ...
    def get_best_available_connector(self) -> Optional[object]:
